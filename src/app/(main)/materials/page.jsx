                ...
                <table className="w-full border-collapse">
                  <thead className="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-white">
                    <tr>
                      ...
                      <th className="px-3 py-2 text-left text-xs font-semibold uppercase cursor-pointer select-none" onClick={() => requestSort('sap_name')}>SAP Name {getSortIcon('sap_name')}</th>
                    ...
                    {sortedMaterials.length > 0 ? (
                      sortedMaterials.map((material, index) => (
                        ...
                        >
                          ...
                          <td className="px-3 py-2 text-xs text-gray-900 max-w-xs truncate" title={material.long_name || material.notes || ""}>{material.long_name || material.notes || "-"}</td>
